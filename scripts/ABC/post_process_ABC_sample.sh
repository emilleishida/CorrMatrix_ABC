...
Rscript $PMC/R/plot_confidence.R sample_${num} -c ~/astro/repositories/github/CorrMatrix_ABC/scripts/ABC/templates_quad/config_pmc -o pdf --pmin=0.275_0.8 --pmax=0.335_0.86 -N 200 --gsmooth=70 -C 0 -m 0.306_0.827
